...
class WhatsappStatus extends StatelessWidget {
  ...
  WhatsappStatus({Key? key, required this.title})
    : files = Directory(FileUtils.waPath).listSync()
            ...
            sliver: SliverGrid.count(
              ...
              children: Constants.map(files, (index, item) {
                ...
                return mimeType == null
                    ? SizedBox()
                    : _WhatsAppItem(file: file, path: path, mimeType: mimeType);
              }),
            ),
          ),
        ],
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  IconButton(
                    onPressed: () => saveMedia(),
                    icon: Icon(Icons.download, color: Colors.white, size: 16.0),
                  ),
